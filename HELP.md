...
* The original package name 'auth-service.Microservico para autenticacao e autorizacao' is invalid and this project uses 'auth_service.Microservico.para.autenticacao.e.autorizacao' instead.
